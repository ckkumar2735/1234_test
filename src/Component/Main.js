    ...
    <>
      <div className='container-fluid'>
        <div className='row'>
          ...
          <div className='col-lg-7  mt-3' style={{ background: "#FFFFFF" }}>
            <div className='row'>
              ...
              {currentPage ===  1 && (
                <div>
                  ...
                  <Category />
                  <Card_1 />
                  <button className='btn2 mt-5' onClick={nextPage}>PROCCED</button>
                </div>
              )}
              ...
              {currentPage === 2 && (
                ...
                <StepContainer currentPage={currentPage} />
                  <Basic_Info/>
                  <button className='btn3 my-4' onClick={previousPage}>Go Back</button>
                  <button className='btn2 my-4' onClick={nextPage}>PROCCED</button>
                </div>
              )}
          ...
          <div className='col-lg-5  right_bg'>
          {currentPage === 1 && (
                <div>
